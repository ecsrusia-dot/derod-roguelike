    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{
      ...
      <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-8 items-start max-w-7xl">
        ...
        <div className="hidden lg:block max-w-sm" style={{ color: PALETTE.text }}>
          <p className="text-xs tracking-[0.4em] mb-2" style={{ color: PALETTE.deblan }}>BATTLE PREP REWORK · v1.2</p>
          ...
          <p className="text-sm leading-relaxed mb-6" style={{ color: PALETTE.textDim }}>
            v1.2 — 매 챕터마다 전투 준비. 보스 직전 정비 노드 재개편. 노드 수 확장.
          </p>
          
          <div className="space-y-3 text-xs">
            <div>
              <div className="text-[10px] tracking-[0.3em] mb-1.5" style={{ color: PALETTE.green }}>◇ 매 챕터 전투 준비</div>
              <p style={{ color: PALETTE.textDim }}>
                4개 챕터 모두 첫 노드가 "전투 준비". 챕터마다 빌드 변경 자유.
                전 챕터에서 모은 새 패시브를 활용해 다른 빌드 시도 가능.
              </p>
            </div>
            <div>
              <div className="text-[10px] tracking-[0.3em] mb-1.5" style={{ color: PALETTE.derod }}>◆ 정비 노드 재개편</div>
              <p style={{ color: PALETTE.textDim }}>
                보스 직전 정비 노드 옵션 변경: 휴식(HP 20%) / 패시브 재선택 / 유물 재선택.
                보스에 맞춰 빌드 조정 가능.
              </p>
            </div>
            <div>
              <div className="text-[10px] tracking-[0.3em] mb-1.5" style={{ color: PALETTE.accent }}>◆ 노드 수 확장</div>
              <p style={{ color: PALETTE.textDim }}>
                북부 14 / 숲 16 / 신전 18 / 마계 20. 한 챕터당 더 풍성한 진행.
                중간 layer당 노드 2~4개로 확대.
              </p>
            </div>
          </div>

          <div className="mt-6 pt-5 border-t text-[11px] leading-relaxed" style={{ color: PALETTE.textDim, borderColor: PALETTE.panelBorder }}>
            ◇ 야영지에서 패시브 강화 옵션 제거<br/>
            ◇ 단련 / 명상 옵션도 제거 (효율성 문제)<br/>
