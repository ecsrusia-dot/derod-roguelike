...
import { loadMeta, saveMeta, addSouls, applyUpgrade, applyUnlock, recordExpeditionClear, needsAltarRefresh, getNextRefreshTime, checkAndResetDaily, claimAchievement, getAchievementState, incrementAchievement, setAchievementProgress, completeAchievement, recordChampionshipClear, hasChampionshipClear, isChampionshipDifficultyUnlocked, unlockChampionshipRelic, setLastSeenVersion } from './storage.js';
...
// =========== 보상 선택 ===========
function RewardSelect({ rewards: initialRewards, gem, skills, relics, ultimates, activeSkills = null, onPick, onReroll, hasRerolled, isElite, classId = null, meta = null, expedition = null }) {
...
function ForgeScreen({ relics, skills, activeRelicNames, meta, onCombine, onLeave }) {
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 lg:p-10" style={{
      ...
      <div className="flex flex-row items-center justify-center gap-12 w-full max-w-[1400px]">
        ...
        <div className="flex-shrink-0">
          <PhoneFrame>
            {screen === 'title' && <TitleScreen meta={meta} onStart={() => setScreen('classSelect')} onAltar={enterAltar} onAchievements={() => { setPrevAchievementsBack('title'); setScreen('achievements'); }} onChangelog={() => setShowChangelog({ firstSeen: false })} />}
