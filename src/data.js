  ...
  이프리트: [
    {
      id: '이프리트_영겁지화',
      name: '영겁지화',
      desc: '이프리트 Lv.7 효과 초기화 (보상 풀 재등장).\n지능 +4. 화염 각인 발동 40%.\n발동 시마다 각인 데미지 누적 (지능×0.3씩 추가).\n화염 각인 영구 지속. 치명타 폭발 비활성.\n* 이프리트 재획득 시: 발동 70% (40+30), 데미지 지능×0.3 고정, 폭발 가능.\n* 겁화는 영겁지화의 영향을 받지 않음 (시그니처가 5T 갱신 부여, 누적·영구화 X). 단 영겁지화 단독(이프리트 패시브 없이) 시 겁화 치명타 폭발도 비활성.',
    ...
    },
    {
      id: '이프리트_화신강림',
      name: '화신강림',
      desc: '이프리트 Lv.7 효과 초기화 (보상 풀 재등장).\n지능 +4. 방어 무시 +25 (절대값).\n화염 각인 발동 50%.\n치명타 시 화염 각인 + 겁화 모두 폭발 → 화염 각인 폭발 시 다음 1턴 치명타 확률 +20% (겁화 폭발은 보너스 미적용, 중복 방지).\n* 이프리트 재획득 시: 발동 80% (50+30), 데미지 지능×0.3 고정.',
    ...
    },
    {
      id: '이프리트_연옥지화',
      name: '연옥지화',
      desc: '이프리트 Lv.7 효과 초기화 (보상 풀 재등장).\n지능 +4. 화염 각인 발동 40%.\n치명타 시 화염 각인 + 겁화 모두 폭발.\n화염 각인 또는 겁화 보유 적 공격 시 마법 데미지 +20% (각인/겁화 부여 턴 미적용).\n화염 각인 또는 겁화 보유 적 처치 시 HP +50 (다음 전투 적용).\n* 이프리트 재획득 시: 발동 70% (40+30), 데미지 지능×0.3 고정.',
