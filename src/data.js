...
export const ENEMIES = {
  ...
  champ_frost_wolf: {
    ...
    tier: 'normal', chapter: 'frost_1',
    patterns: [
      { name: '얼음 송곳니', dmg: [13, 18], type: 'attack', frostbite: 4 },
      { name: '얼어붙은 도약', dmg: [18, 24], type: 'attack', heavy: true },
  ...
  champ_frost_brute: {
    name: '얼음 광전사', hp: 140, color: '#3d6a8a',
    desc: '냉기로 단련된 야만 전사',
    tier: 'elite', chapter: 'frost_1',
    patterns: [
      { name: '얼음 도끼', dmg: [16, 22], type: 'attack', frostbite: 4 },
      { name: '광폭한 일격', dmg: [24, 30], type: 'attack', heavy: true, frostbite: 6 },
      { name: '얼음 갑주', dmg: [0, 0], type: 'defend', defense: 35 },
    ],
    drop: { gold: [70, 100], gem: [1, 2] },
  },
  champ_frost_boss1: {
    name: '눈보라의 군주', hp: 280, color: '#7ba3c4',
    desc: '눈보라를 부리는 변경의 지배자',
    isBoss: true, tier: 'boss', chapter: 'frost_1',
    patterns: [
      { name: '얼음 창', dmg: [18, 24], type: 'attack', frostbite: 5 },
      { name: '눈보라 휘몰이', dmg: [10, 14], type: 'attack', frostbite: 8 },  // 강한 동상
      { name: '결빙의 일격', dmg: [28, 36], type: 'attack', heavy: true, frostbite: 6 },
