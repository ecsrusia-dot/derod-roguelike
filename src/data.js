...
export const EXPEDITIONS = [
  {
    ...
    color: '#7ba3c4',
    chapters: [1, 2, 3, 4],  // CHAPTERS 배열의 인덱스
    enemyHpMult: 1.0,
    enemyDmgMult: 1.0,
    curseCount: 0,
    soulReward: 30,        // 원정 클리어 보너스 영혼
    unlockId: null,        // 항상 해금됨
  },
  {
    id: 2,
    name: '심연의 원정',
    ...
    color: '#5c4a8c',
    chapters: [1, 2, 3, 4],
    enemyHpMult: 1.3,      // 적 HP +30%
    enemyDmgMult: 1.2,     // 적 데미지 +20%
    curseCount: 1,         // 시작 시 저주 1개
    soulReward: 60,
    unlockId: 'unlock_expedition_2',
    unlockCost: 200,       // 영혼 200으로 해금
  },
  {
    id: 3,
    name: '광기의 원정',
  ...
  },
  {
    ...
    enemyDmgMult: 1.6,
    curseCount: 3,
    eliteRatio: 0.5,       // 일반 노드의 50%가 엘리트로 변환
    soulReward: 250,
