...
export const PASSIVE_SKILLS = {
  ...
  이프리트: {
    ...
    desc: '불의 정령왕의 힘. 적의 방어를 무시하고 화염으로 태운다',
    classOnly: 'sage',
    minorEffect: { type: 'ifritStat+', perLv: 1, desc: '지능 +1/Lv, 방어 무시 +5/Lv (절대값)' },
    tiers: {
      3: { text: '마법 공격 시 30% 확률로 화염 각인 (3턴, 매턴 지능×0.3 데미지, 방어 무시)', trigger: 'onAttack', effect: 'igniteOnHit' },
      5: { text: '치명타 적중 시 화염 각인 즉시 폭발 (남은 턴 × 데미지 × 2배 즉발)', trigger: 'onCrit', effect: 'igniteExplode' },
      7: { text: '화염 각인 지속 +1턴 (총 4턴), 지능 +5', trigger: 'passive', effect: 'ifritMastery' }
    }
  },
};
  ...
  이프리트: [
    {
      id: '이프리트_영겁의화염',
      name: '영겁의 화염',
      desc: '화염 각인 영구 지속 (덮어쓰기/폭발 외 자연 소멸 X).\n화염 각인 데미지 +50%.\n화염 각인 발동 확률 +30% (총 60%).',
    ...
    },
    {
      id: '이프리트_강림',
      name: '이프리트의 강림',
      desc: '방어 무시 +25 (절대값, 합계 60).\n치명타 발생 시 화염 각인 폭발 후 즉시 재부여.\n화염 각인 발동 확률 +20% (총 50%).\n치명타 데미지 +30%.',
    ...
    },
    {
      id: '이프리트_정신의화로',
      name: '정신의 화로',
      desc: '화염 각인된 적이 있으면 매 턴 에테르 +1.\n화염 각인 데미지의 50%만큼 자기 HP 회복 (매 턴).\n결계 사용 시 다음 턴 마법 비용 0 + 화염 각인 +2턴 연장.',
      effect: 'ult_mindForge',
      color: '#ff8c42',
    },
  ],
};
