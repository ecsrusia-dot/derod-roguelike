...
export const CHANGELOG = [
  {
    version: '1.37.0',
    date: '2026-05-18',
    label: '근력·민첩 시그니처 신설 + 지능 시그니처 재설계 + 능력치 클릭 시그니처 모달',
    changes: [
      ...
      { type: 'feature', text: '[전투 시작 영혼 로그 노출] 직업 궁극 보유 직업의 전투 첫 로그에 "◆ 시작 영혼 게이지: 지능 +N + 각인 +N + 유물 +N + 메타 +N = 합계" 형식으로 계산식 자동 표시. 0인 소스는 표시 안 함. 합계가 0이면 라인 자체 생략' },
      ...
      { type: 'system', text: '[helpers.js 시그니처 헬퍼 6종 추가] getStrengthHpBonus / getStrengthSoulPerPhys / getAgilityCritDmgBonus / getAgilitySoulOnDodge / getIntellectStartSoul / getIntellectSoulPerMagic. 기존 getIntellectSoulBonus·getIntellectEtherBonus 제거 (의미 재정의로 인한 이름 명확화)' },
      ...
      { type: 'system', text: '[StatusPanel 라벨 갱신] 기타 효과 섹션에 근력(시작HP)·근력(물리영혼)·민첩(치명뎀)·민첩(회피영혼)·지능(시작영혼)·지능(마법영혼) 6종 시그니처 라인 추가. 능력치 그리드 4칸을 button으로 전환, 하단에 "능력치를 눌러 시그니처 효과를 확인하세요" 안내 문구' },
    ],
  },
  {
    version: '1.36.1',
