...
export const CHANGELOG = [
  {
    ...
    changes: [
      ...
      { type: 'feature', text: '[던파식 방 진행형 던전] 무너진 회랑(파밍) = 쫄방 2 → 네임드 → 보스 4방 돌파, 심연의 제단(레이드) = 파수꾼 → 쌍둥이 → 군주 3관문. 파티 HP는 방 사이 10%만 회복하는 소모전 — 장비가 좋을수록 더 깊이 돌파. 네임드·보스 방마다 장비 즉시 드랍, 중도 전멸·후퇴해도 돌파한 방의 전리품은 보존' },
    ],
  },
  {
    version: '1.73.0',
