...
export const EVENTS = [
  ...
  // === 1.97.0~ 황혼의 벨트 연계 사건 ===
  {
    id: 'twilight_alchemist',
    title: '황혼의 연금술사',
    text: '보랏빛 연기가 피어오르는 낡은 수레 앞, 두건을 쓴 연금술사가 유리병을 흔들어 보인다.\n"황혼을 걷는 자여, 이 물약이 언젠가 그대의 목숨을 구할 걸세."',
    chapter: [1, 2, 3, 4],
    choices: [
      {
        text: '물약을 청한다 (랜덤 포션 +1)',
        result: '연금술사가 벨트에 유리병 하나를 꽂아준다.\n"부디 마실 일이 없기를."',
        reward: { type: 'potion_random' },
      },
      {
        text: '제조 비법 이야기를 듣는다 (보석 +1)',
        result: '연금술사의 긴 이야기 끝에, 답례로 반짝이는 보석 하나를 받았다.',
        reward: { type: 'gem', value: 1 },
      },
    ],
  },
];
