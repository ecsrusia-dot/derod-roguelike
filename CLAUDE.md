...
| 현재 게임 버전 | **1.107.0** (⚰ 무덤의 유산 시리즈: 1.103 신설 → 1.104 원작 확장 → 1.105 재련소 → 1.106 유니크 30+방벽 → 1.107 이벤트 방+접두어 → 1.108 저주 18종 → 1.109 조우 직업 3종 → 1.110 유니크 60종 완성. **원전: docs/buried-reference.md** — PM 제공 나무위키 7문서 요약, 유니크 113·직업 70·저주 72 등 미이식 원전 포함. PM 승인 4패키지 전부 출시 완료) / 이전 **1.90.0** (1.79~1.81 레이드 백그라운드·자동 사냥 확장 → 1.82 각성 스킬 15종 → 1.83~1.84 자동 전적·업적 롤백 픽스 → 1.85 도박장 → 1.86~1.87 레이드 난이도·초월 → 1.88 Wake Lock → 1.89 마스터즈+칭호 → **1.90.0 업적 전면 개편**: 죽은 업적 11개 부활·리뉴얼 + 신규 콘텐츠 업적 20개) |
