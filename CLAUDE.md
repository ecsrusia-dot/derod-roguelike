...
| 현재 게임 버전 | **1.106.0** (1.103.0 ⚰ 무덤의 유산 신설 → 1.104.0 원작 확장 → 1.105.0 재련소·일괄분해 → 1.106.0 전설의 무구 30종+방벽) / 이전 **1.90.0** (1.79~1.81 레이드 백그라운드·자동 사냥 확장 → 1.82 각성 스킬 15종 → 1.83~1.84 자동 전적·업적 롤백 픽스 → 1.85 도박장 → 1.86~1.87 레이드 난이도·초월 → 1.88 Wake Lock → 1.89 마스터즈+칭호 → **1.90.0 업적 전면 개편**: 죽은 업적 11개 부활·리뉴얼 + 신규 콘텐츠 업적 20개) |
