...
| 4 | 마계의 균열 (마족·마왕) | ✅ 5종 + 보스 진입 컷신 완료 (1.20.0) |
...
### 진행 가능한 다음 작업
- **챕터 1·2 적 일러스트 재생성** ⚠️ 우선순위 — 챕터 3·4와 화풍 통일 위해 프롬프트 재작성됨 (4단 구성: 레퍼런스 첨부 헤더 + 직물형 머리카락 + 일체형 의상 + "전투모션과 이펙트 필요"). 챕터 1 7장 + 챕터 2 7장 = 14장 신규 생성 필요. 기존 일러는 신규 일러로 교체될 때까지 유지
